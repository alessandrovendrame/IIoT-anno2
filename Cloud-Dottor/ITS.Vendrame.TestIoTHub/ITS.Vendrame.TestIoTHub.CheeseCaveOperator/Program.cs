...
namespace ITS.Vendrame.TestIoTHub.CheeseCaveOperator
{
    class ReadDeviceToCloudMessages
    {
        // Global variables.
        // The Event Hub-compatible endpoint.
        private readonly static string s_eventHubsCompatibleEndpoint = "sb://iothub-ns-cheesecave-10780184-bc3c5acd96.servicebus.windows.net/";

        // The Event Hub-compatible name.
        private readonly static string s_eventHubsCompatiblePath = "cheesecavehub-vendrame";
        private readonly static string s_iotHubSasKey = "QvMB2nb7SDgOgRZlGhMhlUVPvENX8utv7UUHfTVnEa4=";
        private readonly static string s_iotHubSasKeyName = "service";
        private static EventHubClient s_eventHubClient;

        // Connection string for your IoT Hub.
        private readonly static string s_serviceConnectionString = "HostName=CheeseCaveHub-Vendrame.azure-devices.net;SharedAccessKeyName=iothubowner;SharedAccessKey=rRcL3yc/heIpZFX7dwYnRoTAKMYccJDgzRiY6yvRItg=";
