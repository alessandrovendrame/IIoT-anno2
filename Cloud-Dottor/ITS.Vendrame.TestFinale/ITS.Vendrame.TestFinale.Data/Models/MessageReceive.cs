...
namespace ITS.Vendrame.TestFinale.Data.Models
{
    ...
    public class MessageReceive
    {
        ...
        private void ProcessReceivedMessage(Message receivedMessage)
        {
            ...
            var departmentId = splittedString[0];
            var ticketNumber = int.Parse(splittedString[1]);
            ...
            var messagesTable = tableClient.GetTableReference("ticketTable");

            messagesTable.CreateIfNotExistsAsync();

            var message = new TicketEntity(department);
