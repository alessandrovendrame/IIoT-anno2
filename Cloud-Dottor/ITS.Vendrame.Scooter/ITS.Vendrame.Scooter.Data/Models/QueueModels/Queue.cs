...
namespace ITS.Vendrame.Scooter.Data.Models.QueueModels
{
    public class Queue
    {
        ...
        //-------------------------------------------------
        public IEnumerable<QueueMessageModel> DequeueMessage(string queueName)
        {
            var list = new List<QueueMessageModel>();
            ...
            if (queueClient.Exists())
            {
                ...
                {
                    list.Add(JsonSerializer.Deserialize<QueueMessageModel>(message.MessageText));
