...
void __attribute__((picinterrupt(("")))) lampeggio(){

    if(INTCON & 0x04){
        timerFirstLed++;

        if(timerFirstLed >= 2000){
            if(statoFirstLed == 1){
                statoFirstLed = 0;
                PORTB = PORTB & 0x02;
            }else{
        ...
        if(statoSecondLedPre == 1){
            timerSecondLedOff++;
            if(timerSecondLedOff >= 5000){
                PORTB = PORTB | 0x02;
                timerSecondLedOff = 0;
                statoSecondLedPre=0;
        ...
        if(statoSecondLedPost == 1){
            timerSecondLedOn++;
            if(timerSecondLedOn >= 4000){
                timerSecondLedOn=0;
